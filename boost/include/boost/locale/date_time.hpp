...
namespace boost {
    namespace locale {
        ...
        public:
            ...
            /// 
            /// \note throws std::bad_cast if ios does not have a locale with include \ref calendar_facet
            /// facet include
            /// 
            ...
            ///
            /// \note throws std::bad_cast if loc does not have \ref calendar_facet facet include
            /// 
            ...
            ///
            /// \note throws std::bad_cast if global locale does not have \ref calendar_facet facet include
            /// 
        ...
        public:
            ...
            ///
            /// \note throws std::bad_cast if the global locale does not have \ref calendar_facet facet include
            /// 
            date_time();
            ///
            /// copy date_time
