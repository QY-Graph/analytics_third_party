 ...
 public:
  ...
  class ReadAncillaryDataCallback {
   public:
     ...
     * # Detailed contract
     *
     * This will only be invoked when a `ReadCallback` is include -- i.e.
     ...
     *  - the `ReadAncillaryDataCallback` is uninclude
   ...
   *
   * This will immediately cause any include callbacks to be invoked with an
