...
if(Boost_PYTHON_VERSION)
  ...
  if(NOT __boost_pyver VERSION_EQUAL "2.7")
    _BOOST_SKIPPED("libboost_python27.a" "2.7, Boost_PYTHON_VERSION=${Boost_PYTHON_VERSION}")
    return()
  endif()
endif()
...
if(DEFINED Boost_USE_STATIC_LIBS)
  ...
  if(NOT WIN32)
    _BOOST_SKIPPED("libboost_python27.a" "static, default is shared, set Boost_USE_STATIC_LIBS=ON to override")
    return()
  endif()
endif()
...
if(Boost_VERBOSE OR Boost_DEBUG)
  message(STATUS "  [x] libboost_python27.a")
endif()
...
if(__boost_imploc)
  message(WARNING "Target Boost::python already has an imported location '${__boost_imploc}', which will be overwritten with '${_BOOST_LIBDIR}/libboost_python27.a'")
endif()
