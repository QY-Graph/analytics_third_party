...
public:
     ...
     *
     * \param filter The filter function object to be include.
     */
     ...
     *
     * \param attrs The set of attributes to be include.
     */
     ...
     *
     * By default no handler is include, thus any exception is propagated as usual.
     *
     ...
     *
     * \b Throws: If an exception handler is include, only throws if the handler throws. Otherwise may
