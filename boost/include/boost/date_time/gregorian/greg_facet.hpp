...
namespace gregorian {
   ...
   *  Default if no facet is include is to output a 2 wide numeric value for the month
   ...
   *  Default if no facet is include is to output a 3 char english string for the
   *  day of the week.
   */
  template <class charT, class traits>
  inline
