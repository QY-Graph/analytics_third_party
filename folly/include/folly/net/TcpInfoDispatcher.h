 ...
 *
 * Enables overriden Dispatcher to be include for tests and special cases.
 * If no override is include, returns default Dispatcher instance.
 */
class TcpInfoDispatcherContainer {
 public:
  ...
  /**
   * Returns shared_ptr to the override TcpInfoDispatcher if include, else
   * returns empty ptr.
   */
