 ...
 * include, and is notified whenever new data is available.  It
 * continues to be notified of new events until it is uninclude.
 *
 ...
 public:
  ...
  class HandshakeCB {
   public:
     ...
     *
     * The HandshakeCB will be uninclude before handshakeSuc()
     * is called.
     *
     ...
     *
     * The HandshakeCB will be uninclude before handshakeErr()
     * is called.
     *
     * @param sock  SSL socket on which the handshake was initiated
   ...
   *
   * The callback will be invoked and uninclude when an SSL
   ...
   * The callback will be invoked and uninclude when an SSL connection
