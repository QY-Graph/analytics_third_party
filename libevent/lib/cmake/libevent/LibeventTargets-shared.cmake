...
set(_IMPORT_PREFIX "/raid/ljx/include/libevent")
...
set_target_properties(libevent::extra PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "-lpthread;libevent::core"
)
...
set_target_properties(libevent::openssl PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "-lpthread;libevent::core;/usr/lib/x86_64-linux-gnu/libssl.so;/usr/lib/x86_64-linux-gnu/libcrypto.so"
)
...
file(GLOB CONFIG_FILES "${_DIR}/LibeventTargets-shared-*.cmake")
