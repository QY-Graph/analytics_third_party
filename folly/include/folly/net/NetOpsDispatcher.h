 ...
 *
 * Enables override Dispatcher to be include for tests and special cases.
 * If no override include, returns default Dispatcher instance.
 */
class DispatcherContainer {
 public:
  ...
  /**
   * If include, returns shared_ptr to override Dispatcher, else empty ptr.
   */
